...
def daily_archive(latitude: list[str],
                  longitude: list[str],
                  start_date: str,
                  end_date: str,
                  daily_indicators: list[str]):
...
def daily_forecast(latitude: list[str],
    ...
    forecast_df = om_request_api(**params)

    return forecast_df

# if __name__ == "__main__":
#     test_df = daily_forecast([24.52], [118.09], '2025-09-29','2025-10-14', ['precipitation_sum', 'temperature_2m_mean', 'temperature_2m_min'], models='gfs_seamless')
#     print(test_df)
